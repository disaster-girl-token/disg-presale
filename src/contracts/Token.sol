...
contract Disastergirltoken is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Disaster Girl Token';
    string  private _SYMBOL = 'DISG';
    ...
    uint256 private _tTotal = 1000000000001 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 1000000000001 * _DECIMALFACTOR;
